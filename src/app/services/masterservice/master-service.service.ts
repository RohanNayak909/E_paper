...
export class MasterServiceService {
  ...
  getAllheadersEdition(customer_id:any,edate:any,catname:any) {
    return this.HTTP.get<any>(MasterAPI + `/get-header-edition?customer_id=${customer_id}&edate=${edate}&catname=${catname}`);
  }
